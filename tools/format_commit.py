...
Usage:
    python tools/format_commit.py "component_in_snake_case: message" \
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "subject",
        help="commit subject line (component_in_snake_case: message)",
    )
    parser.add_argument(
        "--context",
        action="append",
...
def _validate_subject(subject: str) -> None:
    ...
    if not SUBJECT_COMPONENT_RE.fullmatch(component):
        raise ValueError("subject component must be snake_case (lowercase letters, digits, underscores)")
