...
def write_outputs(
    ...
    with phase(profiler, "write_outputs"):
        ...
        write_json(layout.root / "capabilities.json", derived.capabilities)
        write_json(layout.root / "subsystems.json", derived.subsystems_payload)
        write_json(layout.root / "surface_map.json", derived.surface_map_payload)
